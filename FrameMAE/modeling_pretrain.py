...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, num_frames=100, tubelet_size=2):
        super().__init__()
...
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
        ...
        self.patch_embed = PatchEmbed(
            img_size=224, patch_size=16, in_chans=3, embed_dim=768,tubelet_size=2)
    ...
    def forward_features(self, x, mask):
        ...
        num_patches = 98*T
        self.pos_embed = get_sinusoid_encoding_table(num_patches, 768)
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        patch_embed = PatchEmbed(
            img_size=224, patch_size=16, in_chans=3, embed_dim=768,num_frames=T,tubelet_size=2)
