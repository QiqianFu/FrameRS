...
class VideoMAE(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        self.args.window_size=(duration/2, self.args.input_size // patch_size[0], self.args.input_size //patch_size[1])
        ...
        process_data = process_data.view((duration, 3) + process_data.size()[-2:]).transpose(0,1)  # T*C,H,W -> T,C,H,W -> C,T,H,W
